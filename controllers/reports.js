...
//       if (startDate) {
//         match.payment_date.$gte = new Date(startDate);
//       }

//       if (endDate) {
//         match.payment_date.$lte = new Date(
//           endDate + 'T23:59:59'
//         );
//       }
//     }
...
//         p => p.bill_id_ref?.visit_id_ref
//       );
//     }

//     if (billType === 'IPD') {
//       payments = payments.filter(
//         p => p.bill_id_ref?.ipd_admission_id_ref
//       );
//     }
...
//     res.status(500).json({
//       message:
//         'Failed to generate payment reconciliation report'
//     });
//   }
// };
